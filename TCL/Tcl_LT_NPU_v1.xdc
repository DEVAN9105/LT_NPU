#---------- LT_NPU ----------#
## GLB
set_property -dict [list CONFIG.Load_Init_File {true} CONFIG.Coe_File {C:/Vivado_test/LT_NPU/PosP/GLB.coe}] [get_ips GLB]
...
## Ch_to_Y
set_property -dict [list CONFIG.Load_Init_File {true} CONFIG.Coe_File {C:/Vivado_test/LT_NPU/PosP/Channel_To_Y.coe}] [get_ips Ch_to_Y]
...
## IS / VLIW
set_property -dict [list CONFIG.Load_Init_File {true} CONFIG.Coe_File {C:/Vivado_test/LT_NPU/PosP/IS.coe}] [get_ips IS_storage]
...
set_property -dict [list CONFIG.Load_Init_File {true} CONFIG.Coe_File {C:/Vivado_test/LT_NPU/PosP/VLIW.coe}] [get_ips VLIW_storage]

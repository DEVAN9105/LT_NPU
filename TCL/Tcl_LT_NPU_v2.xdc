## Ch_to_Y
set_property -dict [list CONFIG.Load_Init_File {true} CONFIG.Coe_File {C:/Vivado_test/LT_NPU/Stage_3/Channel_To_Y.coe}] [get_ips Ch_to_Y]
...
## IS / VLIW
set_property -dict [list CONFIG.Load_Init_File {true} CONFIG.Coe_File {C:/Vivado_test/LT_NPU/Stage_3/IS.coe}] [get_ips IS_storage]
...
set_property -dict [list CONFIG.Load_Init_File {true} CONFIG.Coe_File {C:/Vivado_test/LT_NPU/Stage_3/VLIW.coe}] [get_ips VLIW_storage]
...
## GLB
set_property -dict [list CONFIG.Load_Init_File {true} CONFIG.Coe_File {C:/Vivado_test/LT_NPU/Stage_3/GLB.coe}] [get_ips GLB]

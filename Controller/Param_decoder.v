...
module Param_decoder(
    ...
    // IS
    input [25:0] output_combined, // {glb_out_mode, glb_width_out, glb_ch_out, tile_ch_out}
    ...
    // GLB control
    assign glb_input_param = {input_combined[25:24], input_AGU_G_initial, input_AGU_T_initial, input_combined[23:16], input_combined[15:8], input_combined[23:16], input_combined[7:0]};
    assign glb_output_param = {output_combined[25:24], output_AGU_G_initial, output_AGU_T_initial, output_combined[23:16], output_combined[15:8], output_combined[23:16], output_combined[7:0]};
    // prep control

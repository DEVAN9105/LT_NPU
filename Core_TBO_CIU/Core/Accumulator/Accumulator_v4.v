...
module Accumulator(
    ...
    // compare chain
    wire signed [15:0] PE_out_0_trunc = PE_out_0[27:12];
    wire signed [15:0] PE_out_1_trunc = PE_out_1[27:12];
    ...
    always@(*) begin
        if(accumulator_reg[47:27] != {21{accumulator_reg[27]}}) begin
            ...
            acc_out_truncated = accumulator_reg[27:12];
        end
    end

...
module Prep_buffer_sdp (
    ...
    xpm_memory_sdpram #(
        ...
        .BYTE_WRITE_WIDTH_A(128),       // Port A 寫入寬度 (不使用 Byte Enable)
        ...
        .MEMORY_SIZE(16384),            // 總容量 bits = 128 * 128 = 16,384
        .MESSAGE_CONTROL(0),
        .READ_DATA_WIDTH_B(64),         // Port B 讀取寬度
        .READ_LATENCY_B(2),             // Port B 讀取延遲 (含外部 reg)
        .USE_MEM_INIT(0),
        .WAKEUP_TIME("disable_sleep"),
        .WRITE_DATA_WIDTH_A(128),       // ★ 修正：Port A 寫入寬度必須對應 dina
